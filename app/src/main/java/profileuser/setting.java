                ...
                ok.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(avatar.isEmpty()){
                            ...
                            String url = "http://192.168.1.4/Android/updateavatar.php";
                ...
                ok.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(backGround.isEmpty()){
                            ...
                            String url = "http://192.168.1.4/Android/updatebackground.php";
                ...
                ok.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(mkcu.isEmpty() || mkmoi.isEmpty() || nhaplaimk.isEmpty()){
                            ...
                            String url = "http://192.168.1.4/Android/resetpass.php";
